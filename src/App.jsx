    ...
    <main className="main w-full h-screen bg-black">
      ...
      <section className="hero relative w-full h-[90vh]">
        <div className="heading absolute text-white left-1/2 -translate-x-1/2 top-10 flex flex-col items-center gap-2">
          <h1 id="title" className="text-7xl font-extrabold tracking-tight">macbook pro</h1>
          <h2 className="text-xl font-medium">Oh so pro.</h2>
          <p className="text-sm text-center font-light text-[#e0e0e0] w-3/4 mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus commodi non inventore! Impedit, consequuntur. Non, rerum neque. Officia eos ullam facere amet praesentium fugit animi.</p>
        </div>
        <Canvas
